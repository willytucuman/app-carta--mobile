...
const Login = ({error,name,password,showModal, closeModal, handleSubmit, setName, setPassword}) => {
  return (
   <>
<div id='mymodal' className={`modal ${showModal ? "block" : "hidden"}  min-h-screen bg-gray-100 py-6 flex flex-col justify-center sm:py-12`}>
	<div className=" modal-content relative py-3 sm:max-w-xl sm:mx-auto">
		<div
				...
				<div className="divide-y divide-gray-200">
					<form onSubmit={handleSubmit} className="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
						<div className="relative">
							<input onChange={(e)=>setName(e.target.value)} value={name} autoComplete="off" id="name" name="name" type="text" className="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:borer-rose-600" placeholder="username" />
